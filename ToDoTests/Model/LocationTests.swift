...
class LocationTests: XCTestCase {
	...
	func test_EqualLocations_AreEqual() {
		let first = Location(name: "")
		let second = Location(name: "")
		
		XCTAssertEqual(first, second)
	}
	
	func test_TestLocations_WhenLatitudeDiffers_AreNotEqual() {
	...
	func test_TestLocations_WhenLongitudeDiffers_AreNotEqual() {
		performNotEqualTestWith(firstName: "Foo",
		                        secondName: "Foo",
